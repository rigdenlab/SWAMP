...
class MockShelxe(Shelxe):
    ...
    @property
    def pdbout(self):
        """Override :py:attr:`~swmap.wrappers.shelxe.Shelxe.pdbout` so it has a setter"""
        return self._pdbout
    ...
    def run(self):
        ...
        self.pdbout = create_tempfile(content=file_contents)
        self.get_scores()
...
class MyTestCase(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual("20.64", shelxe.cc)
        self.assertEqual("13.0", shelxe.acl)
