...
class ExtraTrees(Classifier):
    """Extreme Random Forests classifier `"""
    ...
    @property
    def _clf(self):
        return ExtraTreesClassifier(random_state=89)

    # Train the classifier
    def train_classifier(self, get_stats=False):
        # Create Random forest
        self.trained_classifier = ExtraTreesClassifier(random_state=89, n_jobs=self.n_jobs, **self._best_params)
...
if __name__ == '__main__':
    my_pred = ExtraTrees("/home/filo/Documents/Data/MR_edge_cases/ml_prepared_data_NEWGEN_balanced.csv")
    my_pred.n_jobs = 12
    my_pred.n_iter = 1
