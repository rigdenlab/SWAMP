...
project = u'SWAMP'
copyright = u'2019-{}, University of Liverpool'.format(datetime.datetime.now().year)
author = u'Filomeno Sanchez, Ronan Keegan & Daniel Rigden'
...
html_context = {
    ...
    'github_url': 'https://github.com/rigdenlab/swamp.git',
}
...
html_title = u'SWAMP v{0}'.format(version)

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = u'SWAMP'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = '_static/logo_swamp.svg'
...
texinfo_documents = [
    (master_doc, 'SWAMP', u'SWAMP Documentation', author, 'SWAMP', 'One line description of project.',
     'Miscellaneous'),
]
