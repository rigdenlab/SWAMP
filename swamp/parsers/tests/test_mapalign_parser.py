...
"""
        ...
        parser = MapAlignParser(stdout=stdout_contents)
        parser.parse()
        ...
        self.assertEqual(44.5272, parser.con_sco)
        self.assertEqual(-4.38, parser.gap_sco)
        self.assertEqual(40.1472, parser.total_sco)
        self.assertEqual(74.0, parser.alignment_length)
        self.assertDictEqual(alignment, parser.alignment)
        self.assertTupleEqual((alignment, 44.5272, -4.38, 40.1472, 74.0), parser.summary)
