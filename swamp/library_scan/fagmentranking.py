...
from swamp.library_scan.targetsplit import SplitTarget
from swamp.library_scan.mapalignscan import MapAlignScan
from swamp.library_scan.aleigenscan import AlEigenScan
...
"""
    ...
    @property
    def splitter(self):
        """Target splitter :obj:`~swamp.library_scan.targetsplit.SplitTarget`"""
    ...
    def _make_dataframe(self, results, **kwargs):
        ...
        :type results: list
        :param kwargs: Passed to :obj:`~swamp.library_scan.fragrank._get_best_alignment`
        :return: no value
        :rtype: None
        """
