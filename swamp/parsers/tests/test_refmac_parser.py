...
"""
        ...
        self.assertTupleEqual(('0.0365', '0.1007'), parser.chirvol_delta)
        self.assertTupleEqual(('1.3854', '1.5617'), parser.bondangle_delta)
        self.assertTupleEqual(('0.0127', '0.0067'), parser.bondlenght_delta)
        self.assertTupleEqual(('0.5655', '0.5454'), parser.rfactor_delta)
        self.assertTupleEqual(('0.5811', '0.5742'), parser.rfree_delta)
        self.assertEqual('0.5742', parser.rfree)
        self.assertEqual('0.5454', parser.rfactor)
        self.assertTupleEqual(('0.5454', '0.5742', ('0.5655', '0.5454'), ('0.5811', '0.5742'), ('0.0127', '0.0067'),
                               ('1.3854', '1.5617'), ('0.0365', '0.1007')), parser.summary)
